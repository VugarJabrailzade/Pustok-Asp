...
public class ProductService : IProductService
{
    ...
    {
        return _pustokDbContext.ProductColors.Where(pc => pc.ProductId == productId)
                .Include(c => c.Color).First().Color;
    }
    ...
    {
        return _pustokDbContext.ProductSizes.Where(pc => pc.ProductId == productId)
                .Include(s=> s.Size).First().Size;
    }
